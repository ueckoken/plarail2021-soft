...
const RailroadMap: FC<Prop> = ({
  ...
  return (
    <svg width={640} height={480} viewBox="0 0 640 480">
      ...
      <Rail
        positions={[{ x: 120 - 50, y: 120 - 20 }, { x: 220, y: 80 }, { x: 320 + 10, y: 120 - 20 }]}
        trains={[]}
      />
      <Rail
        positions={[{ x: 120 - 50, y: 120 + 20 }, { x: 320 - 30, y: 120 + 20 }]}
        trains={[train1]}
      />
      <Rail
        positions={[{ x: 320 + 30, y: 120 - 20 }, { x: 520 + 50, y: 120 - 20 }]}
        trains={[]}
      />
      <Rail
        positions={[{ x: 320 - 10, y: 120 + 20 }, { x: 520 + 50, y: 120 + 20 }]}
        trains={[]}
      />
      <Rail
        positions={[{ x: 320 - 20, y: 120 + 30 }, { x: 320 - 20, y: 360 - 10 }]}
        trains={[]}
      />
      <Rail
        positions={[{ x: 320 + 20, y: 120 - 10 }, { x: 320 + 20, y: 360 - 10 }]}
        trains={[]}
      />
